...
public static class Colors
{
    ...
    public static readonly Vector4 Blue = new(0.3f, 0.7f, 1.0f, 1.0f);
    public static readonly Vector4 Purple = new(0.6f, 0.5f, 1.0f, 1.0f);
    public static readonly Vector4 DarkPurple = new(0.6f, 0.6f, 1.0f, 1.0f);
}
