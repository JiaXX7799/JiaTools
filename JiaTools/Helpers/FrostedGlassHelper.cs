...
public sealed unsafe class CleanBackgroundManager(IPluginLog log) : IDisposable
{
    ...
    private void LoadShaders()
    {
        ...
        _alphaFixShader = LoadShaderFromResource(@"JiaTools.Shaders.AlphaFix.cso");
        _blurHorizontalShader = LoadShaderFromResource(@"JiaTools.Shaders.HBlur.cso");
        _blurVerticalShader = LoadShaderFromResource(@"JiaTools.Shaders.VBlur.cso");
